...
function renderMap(lat, lon) {
  ...
  function _getIso() {
    _getIso = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(lat, lon) {
      var query, data;
  ...
  marker.setLngLat(lngLat).addTo(map); // const geocoderFrom = new MapboxGeocoder({
  ...
  var collision = '';
  var detail = '';
  var reports = document.getElementById('reports'); // function addCard(id, element, clear, detail) {
  ...
  document.querySelector('.modal__button').addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return findCurrentCoordinates();

          case 2:
            myCurrentPosition = _context.sent;
            document.querySelector('.mapbox-directions-origin .mapboxgl-ctrl-geocoder > input').value = "".concat(myCurrentPosition.lon.toFixed(5), ",").concat(myCurrentPosition.lat.toFixed(5));
            document.querySelector('.mapbox-directions-destination .mapboxgl-ctrl-geocoder > input').value = "".concat(lon.toFixed(5), ",").concat(lat.toFixed(5));
  ...
  _createClass(Court, [{
    ...
    value: function () {
      var _renderCourt = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(item) {
        ...
        var court, myCurrentPosition, courtsAPI;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 6;
                return this.findCurrentCoordinates();

              case 6:
                myCurrentPosition = _context2.sent;
                _context2.next = 9;
                ...
                court.addEventListener('click', function (e) {
                  courtsAPI.map(function (item) {
                    if ("court-".concat(item.id) === e.target.id) {
                      _this.modalWrapper.innerHTML = "\n            <div class=\"modal__img\"><img src=\"".concat(item.photos[0], "\" alt=\"\"></div>\n            <div class='modal__content'>\n              <h2 class=\"modal__name\">").concat(item.name, "</h2>\n              <p class=\"modal__address\">").concat(item.address, "</p>\n              <ul class=\"modal__schedule\">\n                <p>\u0420\u0410\u0421\u041F\u0418\u0421\u0410\u041D\u0418\u0415:</p>\n                ").concat(item.schedule.map(function (li) {
                      ...
                      (0, _map.default)(lat, lon); // document.querySelector('.mapbox-directions-origin .mapboxgl-ctrl-geocoder > input').value = `${myCurrentPosition.lon.toFixed(5)},${myCurrentPosition.lat.toFixed(5)}`
                  ...
                  document.querySelector('.modal__close').addEventListener('click', _this.toggleModal);
                });
    ...
    key: "findCurrentCoordinates",
    value: function findCurrentCoordinates() {
      return new Promise(function (resolve, reject) {
        navigator.geolocation.getCurrentPosition(function (position) {
          resolve({
            lat: position.coords.latitude,
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 2:
                ...
                courtsAPI.map(function (item) {
                  return _this2.renderCourt(item);
                }).join('');
...
},{"./map":"js/map.js"}],"js/index.js":[function(require,module,exports) {
"use strict";
...
// renderMap()
var courts = new _courts.default();
},{"./courts":"js/courts.js","./map":"js/map.js"}],"C:/Users/User/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
